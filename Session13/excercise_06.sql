create database library_management_06;
use library_management_06;
...
DELETE FROM readers where readerId NOT IN (
select distinct readerId
from borrows
);
DELETE from books where bookID NOT IN(
Select distinct bookID from borrows);
DELETE from borrows where bookID = 1;